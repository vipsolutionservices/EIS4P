...
Index și fapte comune. Proiectul are două teme distincte, care nu se amestecă; fiecare are propriul fișier în `01-AI\rag\`.
...
|---|---|---|
| Produsul care dă numele proiectului: VOGO eBS Intelligence Suite 4 Production — ETL, depozit de date, BI, Agentic AI pe producție | `01-AI\rag\eis4p-produs.md` | Orice discuție despre ce trebuie construit. |
| Codul găzduit în repository: `vogo-mcp`, serviciu de memorie externă pentru asistenți AI | `01-AI\rag\vogo-mcp-memorie.md` | Orice atingere a codului existent din `src\`, `db\` sau `smoke.sh`. |
| Cererea concretă pentru produs: PoC-ul clientului Marcel SRL — structura de date cerută și ce a livrat clientul | Proiectul `MARCEL`, prin `C:\VOGO\30-PROJECTS\MARCEL SRL\AGENTS.md` | Orice discuție despre ce se construiește primul, ce se demonstrează sau ce se promite unui client. |
...
Detaliul situației și motivele pentru care s-a decis păstrarea codului aici: `01-AI\CONTEXT.md` și `01-AI\DECISIONS.md` → `D-008`.
